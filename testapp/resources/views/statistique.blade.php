...
.navbar {
    ...
    <body class="antialiased">
     ...
     <!-- redirection vers la base -->
    <div class="navbar">
    <a href="{{ route('gerestock') }}">
        <img src="{{ asset('image/Itemm.png') }}" alt="Logo">
        </a>
    ...
    <div class="container">
    <!-- Button 1: Articles par Satellite -->
    <button type="button" class="btn btn-primary">Articles par Satellite</button>

    <!-- Button 2: Répartition des articles -->
    <button type="button" class="btn btn-secondary">Répartition des articles</button>
</div>
